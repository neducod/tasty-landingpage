    ...
    return(
        <>
            <section className='flex flex-col gap-10 p-6 bg-gray-300'>
                ...
                <div className='flex flex-col sm:justify-center sm:items-center sm:flex-row gap-8 sm:p-14 p-6'>
                    <div className='bg-white p-4 rounded-2xl flex flex-col gap-6'>
                        {/* STAR ICONS */}
                        <p className='sm:w-100'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis ex fuga fugit inventore obcaecati ab est repellat vel blanditiis dignissimos?</p>
